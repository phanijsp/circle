    ...
    protected void onPostExecute(String s) {
        switch (i1) {
            case 0:
                ...
                break;
            case 1:
                Toast.makeText(context, "Login Details sent to Mail", Toast.LENGTH_SHORT).show();
                break;
            case 2:
                Toast.makeText(context, "OTP Sent Successfully", Toast.LENGTH_SHORT).show();
                i = new Intent(context, otpactivity.class);
                ...
                break;
            case 3:
                Toast.makeText(context, "New Login Details Sent to Mail", Toast.LENGTH_SHORT).show();
