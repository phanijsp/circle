...
public class MainActivity extends AppCompatActivity {
    ...
    String[] branches = new String[]{"Select Your Branch", "CSE", "ECE", "IT", "MECH", "CIVIL", "CHEMICAL"};
    String[] dates;
...
//            Toast.makeText(this, "Haven't logged in yet", Toast.LENGTH_LONG).show();
        ...
        lottieAnimationView1 = (LottieAnimationView) findViewById(R.id.loading_animation);
